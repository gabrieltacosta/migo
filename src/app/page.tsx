import { FormRhfSelect } from "@/components/group-form";
        ...
        <div className="mx-auto max-w-7xl">
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            <div className="px-4 sm:px-6 text-center md:mx-auto md:max-w-2xl lg:col-span-6 lg:flex lg:items-center lg:text-left">
              <div>
                <h1 className="mt-4 text-3xl font-bold tracking-tight text-blue-600 sm:text-4xl md:text-5xl">
                ...
                <p className="mt-3 text-base text-gray-600 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                  ...
                  ou baixe o app na App Store! (Obs.: Não é necessário baixar o
